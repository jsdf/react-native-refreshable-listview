    ...
    if (Platform.OS === 'ios') {
      if (
        ...
        if (this.isOldReactNative()) {
          ...
          this.getScrollResponder().scrollTo({
            x: this.lastContentOffsetX,
            y: -(this.lastContentInsetTop + REFRESHING_INDICATOR_HEIGHT),
            animate: false,
          })
        }
      }
