...
var ControlledRefreshableListView = React.createClass({
  ...
  renderRefreshingIndicator() {
    var {isRefreshing, pullingPrompt, holdingPrompt, refreshingPrompt, pullingIndicator, holdingIndicator, refreshingIndicator} = this.props
    var refreshingIndicatorProps = {
      ...
      refreshingPrompt: refreshingPrompt || 'Loading',
