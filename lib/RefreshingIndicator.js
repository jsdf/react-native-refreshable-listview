...
var RefreshingIndicator = React.createClass({
  ...
  renderActivityIndicator(styles) {
    if (this.props.isTouching && this.props.isWaitingForRelease) {
      if (this.props.holdingIndicator!= null) {
        var activityIndicator = this.props.holdingIndicator
      }else {
        var activityIndicator = null
      }
    }else if (this.props.isTouching && !this.props.isWaitingForRelease) {
      if (this.props.pullingIndicator!= null) {
        var activityIndicator = this.props.pullingIndicator
      }else {
        var activityIndicator = null
      }
    }else {
      if (this.props.isRefreshing) {
        if (this.props.refreshingIndicator!= null) {
          var activityIndicator = this.props.refreshingIndicator
        }else {
